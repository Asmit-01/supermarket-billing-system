...
m: // m is a label which is re-executed with the help of goto statement.
    ...
    case 1:
        ...
        if (email == "asmit@gmail.com" && password == "asmit")
        {
            administrator();
        }
        else
...
void Shopping::receipt()
{
    ...
    else
    {
        ...
        m:
            ...
            c++;
            cout << "\n\n Do you want to buy another product? if yes press y else press any other key\n";
            cin >> choice;
        } while (choice == 'y');
        cout << "\n\n\t\t\t____________________________RECEIPT_____________________________\n";
        cout << "\nProductCode \t Name \t Product Quantity \t price \t Amount \t Amount with discount\n";
